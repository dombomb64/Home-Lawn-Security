...
public class LawnMowerStayOnPathGoal extends Goal {
	...
	public boolean canStart() {
		return mob.mowing && !mob.isPathOrGoal(this.mob.getBlockPos().down()) && this.checkForExistingPath();
	}
	...
	public boolean shouldContinue() {
		return mob.mowing && !mob.isPathOrGoal(this.mob.getBlockPos().down()) && checkForExistingPath();
	}
