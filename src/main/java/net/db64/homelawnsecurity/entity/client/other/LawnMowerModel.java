...
public class LawnMowerModel extends EntityModel<LawnMowerRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData body = modelPartData.addChild("body", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -2.0F, -5.0F, 8.0F, 2.0F, 10.0F, new Dilation(0.0F))
			.uv(32, 20).cuboid(-5.0F, -2.0F, -1.0F, 1.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 23.0F, 0.0F));
		...
		ModelPartData engine = body.addChild("engine", ModelPartBuilder.create().uv(16, 27).cuboid(-2.0F, -1.0F, -2.0F, 4.0F, 1.0F, 4.0F, new Dilation(0.0F))
			...
			.uv(12, 32).cuboid(-4.0F, -2.0F, -2.0F, 2.0F, 2.0F, 3.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -2.0F, 0.0F));

		ModelPartData exhaust = engine.addChild("exhaust", ModelPartBuilder.create().uv(22, 32).cuboid(-2.0F, -0.5F, 0.0F, 2.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(-3.0F, -0.5F, 1.0F));
		...
		ModelPartData cord2 = cord1.addChild("cord2", ModelPartBuilder.create().uv(24, 18).cuboid(-0.5F, 0.0F, 1.0F, 3.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(-1.0F, 0.0F, 1.0F));

		ModelPartData wheel0 = body.addChild("wheel0", ModelPartBuilder.create().uv(0, 32).cuboid(0.0F, -2.0F, -2.0F, 2.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(4.0F, -1.0F, -4.0F));

		ModelPartData wheel1 = body.addChild("wheel1", ModelPartBuilder.create().uv(0, 32).mirrored().cuboid(0.0F, -2.0F, -2.0F, 2.0F, 4.0F, 4.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.origin(-6.0F, -1.0F, -4.0F));

		ModelPartData wheel2 = body.addChild("wheel2", ModelPartBuilder.create().uv(0, 32).cuboid(0.0F, -2.0F, -2.0F, 2.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(4.0F, -1.0F, 4.0F));

		ModelPartData wheel3 = body.addChild("wheel3", ModelPartBuilder.create().uv(0, 32).mirrored().cuboid(0.0F, -2.0F, -2.0F, 2.0F, 4.0F, 4.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.origin(-6.0F, -1.0F, 4.0F));
