...
public class PeashooterModel<T extends PeashooterEntity> extends SinglePartEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData base = stem.addChild("base", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData leaf1 = base.addChild("leaf1", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -3.0F, 0.0F));

		ModelPartData cube_r1 = leaf1.addChild("cube_r1", ModelPartBuilder.create().uv(0, 18).cuboid(-3.0F, 0.0F, 0.0F, 6.0F, 3.0F, 6.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 2.0F, 0.0F, 0.48F, -0.7854F, 0.0F));

		ModelPartData leaf2 = base.addChild("leaf2", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -3.0F, 0.0F));

		ModelPartData cube_r2 = leaf2.addChild("cube_r2", ModelPartBuilder.create().uv(0, 18).mirrored().cuboid(-3.0F, 0.0F, 0.0F, 6.0F, 3.0F, 6.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, 2.0F, 0.0F, 0.48F, 0.7854F, 0.0F));

		ModelPartData leaf3 = base.addChild("leaf3", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -3.0F, 0.0F));

		ModelPartData cube_r3 = leaf3.addChild("cube_r3", ModelPartBuilder.create().uv(0, 18).mirrored().cuboid(-3.0F, 0.0F, 0.0F, 6.0F, 3.0F, 6.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, 2.0F, 0.0F, 0.48F, -2.3562F, 0.0F));

		ModelPartData leaf4 = base.addChild("leaf4", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -3.0F, 0.0F));

		ModelPartData cube_r4 = leaf4.addChild("cube_r4", ModelPartBuilder.create().uv(0, 18).cuboid(-3.0F, 0.0F, 0.0F, 6.0F, 3.0F, 6.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 2.0F, 0.0F, 0.48F, 2.3562F, 0.0F));
		...
		ModelPartData cube_r5 = headLeaf.addChild("cube_r5", ModelPartBuilder.create().uv(0, 28).cuboid(-2.0F, 0.0F, 1.0F, 4.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.1745F, 0.0F, 0.0F));
