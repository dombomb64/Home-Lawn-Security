...
public class PeashooterModel extends EntityModel<PeashooterRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData peashooter = modelPartData.addChild("peashooter", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 24.0F, 0.0F));

		ModelPartData stem = peashooter.addChild("stem", ModelPartBuilder.create().uv(16, 28).cuboid(-1.0F, -11.0F, -1.0F, 2.0F, 11.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		ModelPartData head = stem.addChild("head", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -8.0F, -5.0F, 8.0F, 8.0F, 10.0F, new Dilation(0.0F))
			.uv(26, 0).cuboid(-3.0F, -7.0F, -8.0F, 6.0F, 6.0F, 3.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -11.0F, 0.0F));

		ModelPartData mouth = head.addChild("mouth", ModelPartBuilder.create().uv(24, 18).cuboid(-4.0F, -4.0F, -2.0F, 8.0F, 8.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -4.0F, -8.0F));

		ModelPartData headLeaf = head.addChild("headLeaf", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -6.0F, 4.0F));
		...
		ModelPartData base = peashooter.addChild("base", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));
