...
public class ZombieSeedPacketPathfindingEntity extends SeedPacketPathfindingEntity {
	public ZombieSeedPacketPathfindingEntity(EntityType<? extends PathAwareEntity> entityType, World world) {
